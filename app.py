...
@app.route('/login')
def logging_in():
    return render_template('frontend/templates/static/login.html') #username=username

@app.route('/search')
def searching():
    return render_template('frontend/templates/static/searchpage.html') #username=username

@app.route('/mainproductlist')
def main_product():
    return render_template('frontend/templates/static/mainproductlist.html') #username=username
